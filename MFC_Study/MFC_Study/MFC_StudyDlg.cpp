...
// MFC_StudyDlg.cpp: 实现文件
//

#include "pch.h"
#include "framework.h"
#include "MFC_Study.h"
#include "MFC_StudyDlg.h"
...
BEGIN_MESSAGE_MAP(CMFCStudyDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_Cac, &CMFCStudyDlg::OnBnClickedCac)
END_MESSAGE_MAP()
...
void CMFCStudyDlg::OnBnClickedCac()
{
	// TODO: 在此添加控件通知处理程序代码
	INT_PTR nRes;
	CSUMDialog sumDialog;
	nRes = sumDialog.DoModal();
}
